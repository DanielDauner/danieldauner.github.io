...
def get_personal_data():
    ...
    bio_text = f"""
                ...
                <p>
                    I am a graduate of the <a href="https://uni-tuebingen.de/" target="_blank">University of Tübingen</a>. <span style="color: red; font-weight: bold;">Having recently completed my master's thesis, I am looking for promising PhD positions!</span>
                <p>
